    ...
    Plugin.prototype = {
                ...
                $(o)
                    ...
                    .each(function(i, p) {
                        ...
                        if (e.settings.preserveColors) {
                            ...
                            additionalStyles +=
                                compStyle && compStyle.backgroundColor ? 'background-color: ' + compStyle.backgroundColor + ';' : '';
        ...
        tableToExcel: function(table, name, sheetName) {
            ...
            var isIE =
                ...
                (navigator.userAgent.indexOf('Trident') !== -1 && navigator.userAgent.indexOf('rv:11') !== -1); // this works with IE10 and IE11 both :)
